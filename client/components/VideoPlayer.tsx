...
//     }
//     socket.on("video-change-from-server", (videoId) => { setVideoId(videoId); });
...
//       event.target.seekTo(serverTimeStamp, true);
...
//   const opts: YouTubeProps["opts"] = { playerVars: { autoplay: 1, rel: 0, modestbranding: 1, } };
